...
@Component({
  selector: 'app-ncaa-football-scores',
  templateUrl: './ncaa-football-scores.component.html',
  styleUrls: ['./ncaa-football-scores.component.scss']
})
export class NcaaFootballScoresComponent implements OnInit, OnDestroy {
  loadingScores = false;
